...
const app = express();
const config = process.env.SESSION_SECRET || 'Vote, Volunteer, GHElected';
...
//Can use later from the setting page to get account info in order to update it
